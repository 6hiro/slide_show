...
const Privacy = () => {
    return (
        <div className="terms_container">
            <Helmet>
                <meta charSet="utf-8" />
                <title>プライバシーポリシー / {siteTitle}</title>
                <meta
                    name="description"
                    content="プライバシーポリシー"
                />
            ...
            <div>
                <h1>プライバシーポリシー</h1>
                <p>
                    Vlides（以下，「当社」といいます。）は，本ウェブサイト上で提供するサービス（以下,「本サービス」といいます。）における，
                    ユーザーの個人情報の取扱いについて，以下のとおりプライバシーポリシー（以下，「本ポリシー」といいます。）を定めます。
                    {/* Vlides を利用する登録ユーザー（本サービスを利用するために必要なアカウントを有する本サービスの利用者） */}
                </p>
                ...
                <ol>
                    ...
                    <li><Link to={"/terms"}>利用規約</Link>に違反したユーザーや，不正・不当な目的でサービスを利用しようとするユーザーの特定をし，ご利用をお断りするため</li>
                ...
                <ol>
                    ...
                    <li>
                        前 2 項にかかわらず，利用停止等に多額の費用を有する場合その他利用停止等を行うことが困難な場合であって，
                        ユーザーの権利利益を保護するために必要なこれに代わるべき措置をとれる場合は，この代替策を講じるものとします。
                    </li>
                </ol>

                <h2>第 9 条（プライバシーポリシーの変更）</h2>
                <ul>
                    <li>
